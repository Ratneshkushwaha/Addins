...
// eslint-disable-next-line office-addins/no-office-initialize, no-undef
...
function addMsg3ToBody(event) {
  addTextToBody(
    "Visit https://developer.microsoft.com/en-us/outlook/ today for all of your add-in development needs.",
    "red-icon-16",
    event
  );
}
